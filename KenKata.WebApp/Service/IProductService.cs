...
namespace KenKata.WebApp.Service
{
    ...
    public class ProductService : IProductService
    {
        ...
        public async Task<IEnumerable<ProductEntity>> GetAll()
        {
            ...
            var p1 = new ProductEntity() { Name = "Gold Rings", Description = "Jag är beskrivning för guld ringar", Color = "Guld", Price = 129, ImgUrl= "https://cdn.pixabay.com/photo/2018/08/16/19/56/wedding-rings-3611277_960_720.jpg" };
            var p2 = new ProductEntity() { Name = "Armband Silver", Description = "Jag är beskrivning för armband silver", Color = "Silver", Price = 69, ImgUrl= "https://cdn.pixabay.com/photo/2017/07/24/18/47/diamonds-2535677_960_720.jpg" };
            var p3 = new ProductEntity() { Name = "Pärlan väska", Description = "	beskrivning pärlan väskan", Color = "Black", Price = 99 ,ImgUrl= "https://cdn.pixabay.com/photo/2015/11/20/03/53/package-1052370_960_720.jpg" };
            var p4 = new ProductEntity() { Name = "Skor svarta", Description = "svarta skor description", Color = "Black", Price = 59, ImgUrl = "https://cdn.pixabay.com/photo/2017/09/15/13/28/black-shoes-2752226_960_720.jpg" };
